...
class LogAggregator
{
     ...
     */
    public function __construct(Parameters $params, LogAggregatorDao $realDao)
    {
        $this->params = $params;
    ...
    {
        return $this->realDao->generateQuery($this->params, $select, $from, $where, $groupBy, $orderBy);
    }

    public static function getConversionsMetricFields()
    {
        return LogAggregatorDao::getConversionsMetricFields();
    }

    public static function getSqlRevenue($field)
    {
        return LogAggregatorDao::getSqlRevenue($field);
    }
    ...
    {
        return $this->realDao->queryVisitsByDimension($this->params, $dimensions, $where, $additionalSelects, $metrics, $rankingQuery);
    }
    ...
    {
        return $this->realDao->queryEcommerceItems($this->params, $dimension);
    }
    ...
    {
        return $this->realDao->queryActionsByDimension(
            $this->params, $dimensions, $where, $additionalSelects, $metrics, $rankingQuery, $joinLogActionOnColumn);
    }
    ...
    {
        return $this->realDao->queryConversionsByDimension($this->params, $dimensions, $where, $additionalSelects);
    }
    ...
    {
        return $this->realDao->getDbConnection();
    }
}
